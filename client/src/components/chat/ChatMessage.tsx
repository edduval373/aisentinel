  ...
  return (
    <div className="space-y-4">
      ...
      {message.status === 'approved' && message.response && (
        <div className="flex justify-start">
          <div className="bg-white border border-slate-200 rounded-lg px-4 py-2 max-w-xs lg:max-w-md">
            ...
            <p className="text-sm text-slate-700 whitespace-pre-wrap">{message.response}</p>
            <div className="flex items-center justify-between mt-1">
      ...
      {message.status === 'blocked' && (
        <div className="flex justify-start">
          <div className="bg-sentinel-red/10 border border-sentinel-red/30 rounded-lg px-4 py-2 max-w-xs lg:max-w-md">
            <div className="flex items-center space-x-2 mb-2">
