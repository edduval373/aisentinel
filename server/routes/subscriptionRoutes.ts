  ...
  try {
    const plans = [
      ...
      },
      {
        ...
        requiresCreditCard: true,
        requiresApiKey: true,
        features: ['Unlimited AI interactions (your API keys)', 'Unlimited team members', 'Advanced company branding', 'Advanced admin dashboard', 'Custom integrations', 'Dedicated support'],
        isActive: true,
      }
    ];
