...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    if ((path.includes('chat/session') || pathname.includes('chat/session') || path.endsWith('/session')) && req.method === 'POST') {
      console.log('=== PRODUCTION CHAT SESSION CREATION ===');
      console.log('Request URL:', req.url);
      console.log('Referer:', req.headers.referer);
      console.log('X-Demo-Mode header:', req.headers['x-demo-mode']);
      ...
      try {
        ...
        console.log('Session creation analysis:', {
          isDemoMode,
        ...
        // For non-demo mode, return auth required
        console.log('Non-demo mode, authentication required');
